...
export default class IdCardRequest extends LightningElement {
    @track searchKey = '';
    @track studentId = '';
    @track studentName = '';
    ...
    handleSubmit(event) {
        ...
        fields.Request_Date__c = this.todayDate;
    ...
    handleSuccess(event) {
        this.isVerifying = false;
        this.showToast('Success', 'ID Card Request submitted successfully! ID: ' + event.detail.id, 'success');
        this.handleReset();
    }
